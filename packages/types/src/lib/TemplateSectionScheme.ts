...
import { TemplateBlockScheme } from './TemplateBlockScheme';

const __base__TemplateSectionScheme=z.object({
    cols:z.number().array().optional().describe("Column widths percentages as 0 to 1 values"),
    wrap:z.boolean().optional(),
    sourceTemplateId:z.number().int().optional().describe("Id of the MessageTemplate that the section was sourced from"),
...
const __lazy__TemplateSectionScheme=z.object({
    blocks:z.lazy(()=>TemplateBlockScheme).array(),
    visibility:z.lazy(()=>TemplateVisibilityScheme).optional(),
});
export const TemplateSectionScheme:(typeof __base__TemplateSectionScheme)=__base__TemplateSectionScheme.merge(__lazy__TemplateSectionScheme) as any;
